        ...
        <div class="main-left col-span-3">
            <div class="bg-white border border-gray-200 rounded-lg">
                <div class="p-4 flex space-x-4">  
                    <input type="search" class="p-4 w-full bg-gray-100 rounded-lg" placeholder="Что вы ищите?">

                    <a href="#" class="inline-block py-4 px-6 bg-purple-600 text-white rounded-lg">Найти</a>
                </div>
            </div>
